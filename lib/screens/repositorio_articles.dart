import 'package:projeto_2/screens/osartigos.dart';

class ArticlesRepository {
  static List<Articles> length = [
    Articles(
      titulo: ('Rotina para o bebê é importante?'),
      texto:
    ...
    Articles(
      titulo: 'Nariz entupido: O que fazer?',
      texto:
    ...
    Articles(
      titulo: 'Bolinhas no rosto: E agora?',
      texto:
    ...
    Articles(
      titulo: 'Quando iniciar a introdução alimentar?',
      texto:
    ...
    Articles(
      titulo: 'Como iniciar uma introdução alimentar?',
      texto:
    ...
    Articles(
      titulo: 'O que é a introdução alimentar BLW?',
      texto:
    ...
    Articles(
      titulo: 'Dicas de introdução alimentar',
      texto:
    ...
    Articles(
      titulo: 'O que você precisa para iniciar uma introdução alimentar:',
      texto:
